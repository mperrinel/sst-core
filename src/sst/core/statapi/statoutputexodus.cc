...
void StatisticOutputEXODUS::implOutputField(fieldHandle_t UNUSED(fieldHandle), int32_t data)
{
}

void StatisticOutputEXODUS::implOutputField(fieldHandle_t UNUSED(fieldHandle), uint32_t data)
{

}

void StatisticOutputEXODUS::implOutputField(fieldHandle_t UNUSED(fieldHandle), int64_t data)
{

}

void StatisticOutputEXODUS::implOutputField(fieldHandle_t UNUSED(fieldHandle), uint64_t data)
{

}

void StatisticOutputEXODUS::implOutputField(fieldHandle_t UNUSED(fieldHandle), float data)
{
}

void StatisticOutputEXODUS::implOutputField(fieldHandle_t UNUSED(fieldHandle), double data)
{
}
...
void StatisticOutputEXODUS::implStartRegisterGroup(StatisticGroup* group)
{
...
void StatisticOutputEXODUS::implStartOutputGroup(StatisticGroup* UNUSED(group))
{
...
void StatisticOutputEXODUS::implOutputField(fieldHandle_t fieldHandle, traffic_event data){
