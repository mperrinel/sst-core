...
public:
    ...
    {
      std::cout << "AccumulatorStatistic constructor: " << comp->getName() << std::endl;
...
protected:
    ...
    */
    ...
    {
        m_sum += value;
        std::cout << "AccumulatorStatistic :: addData_impl: " << this<< " " << std::to_string(value) << " "<< std::to_string(m_sum) << std::endl;
