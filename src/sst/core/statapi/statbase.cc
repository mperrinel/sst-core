...
//SST_ELI_INSTANTIATE_MULTI_STATISTIC_NO_TEMPLATE(StatVTK, uint64_t, int, double);
//SST_ELI_INSTANTIATE_STATISTIC(StatVTK, uint32_t);
//SST_ELI_INSTANTIATE_STATISTIC(StatVTK, int64_t);
//SST_ELI_INSTANTIATE_STATISTIC(StatVTK, uint64_t);
//SST_ELI_INSTANTIATE_STATISTIC(StatVTK, float);
//SST_ELI_INSTANTIATE_STATISTIC(StatVTK, double);
